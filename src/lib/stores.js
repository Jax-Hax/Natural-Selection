...
export let minMiceSpeed = writable(1);
...
export let minCatSpeed = writable(5);
export let maxCatSpeed = writable(10);
//mice genes
export let minMiceMinHunger = writable(1);
export let maxMiceMinHunger = writable(5);
export let minMiceMaxHunger = writable(10);
export let maxMiceMaxHunger = writable(15);
...
export let minSnakeFoodValue = writable(20);
export let maxSnakeFoodValue = writable(25);
//Cat genes
export let minCatMinHunger = writable(12);
export let maxCatMinHunger = writable(15);
export let minCatMaxHunger = writable(25);
export let maxCatMaxHunger = writable(35);
export let minCatRestTime = writable(1);
export let maxCatRestTime = writable(1);
