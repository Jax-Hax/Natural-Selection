...
export let minSnakeTimeUntilReproduction = writable(15);
export let maxSnakeTimeUntilReproduction = writable(16);
...
export let minCatTimeUntilReproduction = writable(15);
export let maxCatTimeUntilReproduction = writable(16);
...
export let minCatPreyStandards = writable(3);
